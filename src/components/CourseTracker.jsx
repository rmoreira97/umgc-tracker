...
const CourseTracker = () => {
  ...
  const grades = {
    'IFSM 304': {
      items: [
        ...
        { name: 'Paper A', status: 'graded', score: 168, max: 180 },
        { name: 'Week 1 Discussion', status: 'graded', score: 20, max: 20 },
        { name: 'Week 2 Discussion', status: 'graded', score: 20, max: 20 },
        { name: 'Week 3 Discussion', status: 'graded', score: 26, max: 30 },
        { name: 'Paper B', status: 'graded', score: 229, max: 230 },
    ...
    'IFSM 301': {
      items: [
        ...
        { name: 'Week 3 Discussion (REPLY)', status: 'graded', score: 20, max: 20 },
        { name: 'IT Strategic Plan Pt 1', status: 'graded', score: 121.8, max: 140 },
        { name: 'Week 4 Discussion (REPLY)', status: 'graded', score: 20, max: 20 },
        { name: 'IT Strategic Plan Pt 2', status: 'submitted', max: 200 },
    ...
    'IFSM 370': {
      items: [
        ...
        { name: 'Week 4 Discussion', status: 'graded', score: 40, max: 40 },
        { name: 'Project 1: Interview', status: 'graded', score: 140, max: 140 },
        { name: 'Quiz 4', status: 'graded', score: 50, max: 50 },
        { name: 'Quiz 5', status: 'graded', score: 50, max: 50 },
  ...
  const weeklySchedule = {
    ...
    3: { dates: 'Jan 21-27', assignments: [
      { course: 'IFSM 301', name: 'IT Strategic Plan Pt 1', pts: 140, status: 'graded', score: '121.8/140', due: 'Fri Jan 24' },
      { course: 'IFSM 301', name: 'Week 3 Discussion (REPLY)', pts: 20, status: 'graded', score: '20/20', due: 'Tue Jan 28' },
      { course: 'IFSM 304', name: 'Week 3 Discussion', pts: 30, status: 'graded', score: '26/30' },
      { course: 'IFSM 370', name: 'Project 1: Interview', pts: 140, status: 'graded', score: '140/140', due: 'Mon Jan 27' },
    ]},
    4: { dates: 'Jan 28 - Feb 3', assignments: [
      { course: 'IFSM 304', name: 'Paper B', pts: 230, status: 'graded', score: '229/230', due: 'Mon Feb 3' },
      ...
      { course: 'IFSM 304', name: 'Week 4 Discussion', pts: 20, status: 'graded', score: '16/20', note: 'Needed 3 replies' },
      { course: 'IFSM 370', name: 'Quiz 4', pts: 50, status: 'graded', score: '50/50' },
    ]},
    5: { dates: 'Feb 4-10', assignments: [
      { course: 'IFSM 304', name: 'Paper C', pts: 230, status: 'upcoming', due: 'Tue Feb 10' },
      { course: 'IFSM 370', name: 'Project 2: VPN', pts: 140, status: 'upcoming', due: 'Tue Feb 10' },
      { course: 'IFSM 370', name: 'Week 5 Discussion', pts: 40, status: 'submitted', due: 'Post Fri, Reply Tue' },
      { course: 'IFSM 370', name: 'Quiz 5', pts: 50, status: 'graded', score: '50/50' },
      { course: 'IFSM 301', name: 'Week 5 Discussion (HOST)', pts: 20, status: 'submitted', note: 'You HOST this week!' },
    ...
    7: { dates: 'Feb 18-24', assignments: [
      ...
      { course: 'IFSM 304', name: 'Week 7 Discussion', pts: 20, status: 'upcoming' },
    ]},
    8: { dates: 'Feb 25 - Mar 3', assignments: [
      { course: 'IFSM 301', name: 'IT Decision Paper', pts: 250, status: 'upcoming', due: 'Mon Mar 3' },
      ...
      { course: 'IFSM 304', name: 'Week 8 Discussion', pts: 20, status: 'upcoming' },
    ]},
  };
